...
### Step 5.5: Product Verification (Playwright MCP)

If the app has a UI and a dev server is running:
1. Use Playwright MCP to open the app in a real browser.
2. Walk through the FSD user flows — verify UI rendering, interactions, and error states.
3. Record any visual or behavioral issues found.
4. Include Playwright verification results in the output below.
